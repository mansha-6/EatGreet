            ...
            <div className="max-w-[1600px] mx-auto w-full flex-1 flex flex-col space-y-6 min-h-0">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 shrink-0">
                    <div>
                        ...
                        <p className="text-gray-500 font-normal text-sm mt-1">Manage system access and roles.</p>
                    </div>
                    ...
                    <div className="overflow-y-auto no-scrollbar flex-1">
                        <table className="w-full">
                            <thead className="bg-gray-50/50 sticky top-0 z-10">
                                <tr>
                                    <th className="px-6 py-4 text-left text-xs font-normal text-gray-400 uppercase tracking-wider">User</th>
                                    <th className="px-6 py-4 text-left text-xs font-normal text-gray-400 uppercase tracking-wider">Role</th>
                                    <th className="px-6 py-4 text-left text-xs font-normal text-gray-400 uppercase tracking-wider">Joined</th>
                                    <th className="px-6 py-4 text-center text-xs font-normal text-gray-400 uppercase tracking-wider">Status</th>
                                    <th className="px-6 py-4 text-right text-xs font-normal text-gray-400 uppercase tracking-wider">Action</th>
                                </tr>
                            </thead>
                                ...
                                {filteredUsers.map((user, idx) => (
                                    ...
                                    >
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-100 to-indigo-50 flex items-center justify-center text-blue-600 font-normal">
                                                    {user.name.charAt(0)}
                                                </div>
                                                <div>
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="font-normal text-gray-700 text-sm">{user.role}</span>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4">
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            <span className={`inline-flex px-3 py-1 rounded-full text-[10px] font-normal uppercase tracking-wide ${user.status === 'Active' ? 'bg-green-50 text-green-600' : 'bg-gray-100 text-gray-500'
                                                }`}>
                                                {user.status}
                                            </span>
                                        </td>
