                ...
                <div className="flex-1 min-h-0 bg-white/60 backdrop-blur-sm rounded-[2.5rem] border border-white/60 shadow-sm flex flex-col overflow-hidden">
                    ...
                    <div className="p-6 pb-0">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-6">
                            <h2 className="text-2xl font-normal text-gray-900">All Restaurants</h2>
                            <div className="flex items-center gap-3">
                        ...
                        <div className="grid grid-cols-12 gap-4 px-6 mb-4">
                            <div className="col-span-3 text-[10px] uppercase tracking-widest font-normal text-gray-400">Restaurants</div>
                            <div className="col-span-2 text-[10px] uppercase tracking-widest font-normal text-gray-400">Admin Contact</div>
                            <div className="col-span-2 text-[10px] uppercase tracking-widest font-normal text-gray-400">Join Date</div>
                            <div className="col-span-1 text-[10px] uppercase tracking-widest font-normal text-gray-400 text-center">Subscription</div>
                            <div className="col-span-1 text-[10px] uppercase tracking-widest font-normal text-gray-400 text-center">Usage</div>
                            <div className="col-span-1 text-[10px] uppercase tracking-widest font-normal text-gray-400 text-center">Status</div>
                            <div className="col-span-2 text-[10px] uppercase tracking-widest font-normal text-gray-400 text-right pr-4">Action</div>
                        </div>
                    </div>
                        ...
                        {isLoading ? (
                            ...
                            filteredRestaurants.map((restaurant, idx) => (
                                ...
                                >
                                    ...
                                    <div className="col-span-2">
                                        <p className="font-normal text-sm text-gray-800">{new Date(restaurant.createdAt).toLocaleDateString()}</p>
                                    </div>
                                    <div className="col-span-1 flex justify-center">
                                        <span className="px-4 py-1.5 bg-[#E6DAFF] text-[#8C52FF] rounded-full text-[10px] font-normal uppercase tracking-tight">
                                            Premium
                                        </span>
                                    </div>
                                    <div className="col-span-1 text-center">
                                        <p className="font-normal text-sm text-gray-800">45 <span className="text-gray-400 font-normal">Orders</span></p>
                                        <p className="text-[10px] font-normal text-gray-400 uppercase tracking-tighter">Monthly</p>
                                    </div>
                                    <div className="col-span-1 flex justify-center">
                                        <span className="px-4 py-1.5 rounded-full text-[10px] font-normal uppercase tracking-tight bg-[#E7F9F0] text-[#10B981]">
                                            Active
                                        </span>
                                    </div>
