                        ...
                        <div className="flex-1 flex flex-col items-center justify-center">
                            <div className="w-full h-[220px]">
                                <ResponsiveContainer width="100%" height="100%">
                                    <PieChart>
                                        <Pie
                                            data={statsData.planDistribution}
                                            innerRadius="65%"
                                            outerRadius="90%"
                                            paddingAngle={10}
                                            dataKey="value"
                                        >
                                            {statsData.planDistribution.map((entry, index) => (
                                                <Cell key={index} fill={['#10B981', '#F59E0B', '#3B82F6', '#EF4444', '#94A3B8'][index % 5]} />
                                            ))}
                                        </Pie>
                                        <Tooltip />
                                    </PieChart>
                            ...
                            <div className="w-full space-y-4 mt-8">
                                {statsData.planDistribution.map((item, index) => (
                                    <div key={item.name} className="flex justify-between items-center text-sm">
                                        <div className="flex items-center gap-3">
                                            <div className="w-3 h-3 rounded-full" style={{backgroundColor: ['#10B981', '#F59E0B', '#3B82F6', '#EF4444', '#94A3B8'][index % 5]}}></div>
                    ...
                    >
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500">Business activity by city</p>
                            </div>
                        </div>
