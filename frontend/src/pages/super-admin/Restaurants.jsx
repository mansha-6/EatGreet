    ...
    return (
        <div className="w-full bg-[#F0F2F4] px-4 md:px-10 py-6 pb-10">
            <div className="max-w-[1850px] mx-auto w-full space-y-6">
                ...
                <div className="bg-white/60 backdrop-blur-sm rounded-[2rem] sm:rounded-[2.5rem] border border-white/60 shadow-sm flex flex-col">
                    ...
                    <div className="px-4 sm:px-8 pb-6 sm:pb-8 pt-4 space-y-3">
                        {isLoading ? (
